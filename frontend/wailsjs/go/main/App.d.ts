...
export function CreateEncryptedBackup(arg1:string):Promise<main.EncryptedBackup>;
...
export function RestoreEncryptedBackup(arg1:string,arg2:string):Promise<Array<main.Report>>;
